...
/// </summary>
public interface IBinaryObjectStream<TSelf> : IBinaryObjectWrite
    where TSelf : IBinaryObjectStream<TSelf>
{
    /// <summary>
    ...
    /// <param name="result">
    /// the resulting object, shouldn't be null of this returns positive
    /// </param>
    /// <param name="endianness">prefered endianness of the conversion</param>
    /// <returns>
    /// number of written bytes on success, otherwise negative
    /// </returns>
    public static abstract int TryReadFromBinary(
    ...
    public static abstract bool TryReadFromBinary(
                                Stream     data                           ,
