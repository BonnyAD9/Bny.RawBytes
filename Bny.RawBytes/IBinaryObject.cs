...
/// </summary>
public interface IBinaryObject<TSelf> : IBinaryObjectStream<TSelf> where TSelf : IBinaryObject<TSelf>
{
    /// <summary>
    ...
    static bool IBinaryObjectStream<TSelf>.TryReadFromBinary(Stream data, [NotNullWhen(true)] out TSelf? result, Endianness endianness)
    {
        result = default;
